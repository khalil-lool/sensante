...
par un agent de santé communautaire et tu proposes
un pré-diagnostic .
Règles :
...
- Tu NE poses PAS de diagnostic dé finitif .
...
const userMessage = `Patient : ${ patient .prenom}
${ patient .nom}
...
return {
diagnostic : " Analyse impossible . Ré essayez .",
confiance : 0,
recommandation :

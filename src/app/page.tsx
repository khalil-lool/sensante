...
import AlerteIA from "@/components/AlerteIA"; // Assure-toi que ce fichier existe maintenant !
import StatCard from "@/components/StatCard";
import LoginButton from "@/components/LoginButton";

export default function Home() {
  return (
    // On garde la div parente mais on enlève le Header car Layout.tsx s'en occupe déjà
